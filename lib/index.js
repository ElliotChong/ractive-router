(function() {
  ...
  initializePage = (function() {
    ...
    return function(p_options) {
      ...
      page.show = function(p_path, p_state, p_dispatch, p_push) {
        return show(p_path, p_state, p_dispatch, p_push || p_options.pushState || p_options.pushstate);
      };
  ...
  RouteContainer = Ractive.extend({
    ...
    oninit: function() {
      ...
      this.root.on("*." + events.NAVIGATE + " " + events.NAVIGATE, navigate);
      return this.onteardown = function() {
        this._super();
        return this.root.off("*." + events.NAVIGATE + " " + events.NAVIGATE, navigate);
      };
    },
