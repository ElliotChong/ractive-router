(function() {
  ...
  Router = Ractive.extend({
            ...
            component = component.extend({
              oninit: function() {
                ...
                if ((scopes != null ? scopes.length : void 0) > 0) {
                  return this.applyScopes(this.resolveScope(scopes));
                }
              },
              onteardown: function() {
                var _ref;
    ...
    parseRoutes: function(p_routes, p_oldRoutes, p_keypath) {
      var callbacks, path, route, routeCallbacks, _i, _j, _len, _len1;
    ...
    addRoute: function(p_descriptor) {
      ...
      page("*", (function(_this) {
        return function(p_context, p_next) {
          var contentShown, _ref1, _ref2;
          if ((p_context != null ? (_ref1 = p_context.instances) != null ? (_ref2 = _ref1[_this._guid]) != null ? _ref2.finalized : void 0 : void 0 : void 0) !== true) {
