(function() {
  var Promise, Ractive, RouteContainer, assign, events, initializePage, isArray, isEqual, isFunction, isPlainObject, isString, merge, once, page, qs, removeCallback, resolveScope, showCurrent;
  ...
  RouteContainer = Ractive.extend({
      ...
      if (p_component !== this.components["route-content"]) {
        ...
        promise = promise.then(new Promise((function(_this) {
          return function(p_fulfill, p_reject) {
            ...
            if ((component.extend != null) && (scopes != null ? scopes.length : void 0) > 0) {
              component = component.extend({
                oninit: function() {
                  ...
                  scope = resolveScope.call(this, scopes);
                  if (scope != null) {
    ...
    parseRoutes: function(p_routes, p_oldRoutes, p_keypath) {
      ...
      if ((p_oldRoutes == null) && (p_keypath == null)) {
        if (p_oldRoutes == null) {
